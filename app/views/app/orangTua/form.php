<form action="<?= $data['action'] ?>" method="post" id="form-submit">
    ...
    <div class="modal-body">
        <div class="form-group row">
            <label for="" class="col-lg-4">Murid Dari</label>
            <div class="col-lg-8">
                <select name="users_id_siswa" class="form-control select2Server" id="">
                </select>
            </div>
        </div>
        <div class="form-group row">
...
<script class="row_id" data-value="<?= isset($data['row']) ? $data['row']['users_id_siswa'] ?? '' : '' ?>"></script>
<script src="<?= BASEURL ?>/public/js/app/orangTua/form.js"></script>
