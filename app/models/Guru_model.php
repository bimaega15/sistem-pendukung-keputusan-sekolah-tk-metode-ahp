...
class Guru_model extends Controller
{
    private $table = 'users';
    private $db;
...
JOIN roles on roles.id = role_user.roles_id';
    ...
    public function create($data)
    {
        ...
        $searchByRole = $searchRoles->getByRoles('guru');
    ...
    public function searchSelect2($search, $skip)
    {
        ...
        if ($search != null) {
            $sql .= ' WHERE profile.nama_profile = LIKE :search 
            OR WHERE profile.kode_profile = LIKE :search';
        }
